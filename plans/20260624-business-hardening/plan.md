...
|---|---|---|---|
| 01 | Integration test khóa invariant (tiền/tenancy/lương) | P0 | ✅ **xong** — 7 test PASS, có răng (verified), review APPROVE |
| 02 | Siết CI: thêm test vào gate | P0 | ✅ unit+integration đã vào CI · ⏸️ lint hoãn (chưa có eslint — việc riêng) |
| 03 | Hoàn thiện nghiệp vụ còn thiếu (chatter UI + chốt hoa hồng) | P1 | ⬜ |
