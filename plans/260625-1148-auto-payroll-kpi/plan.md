...
| 05 | Phiếu đánh giá KPI: model + workflow draft→submit→confirm→approved + criteria-in-policy | — | ✅ unblocked, pending build | 01,04 |
| 06 | Auto-prefill ô định lượng (calls/tái tục/điểm HS) + đổ điểm sang payslip khi approved | — | pending | 05,03 |
| 07 | UI phiếu KPI (kanban trạng thái + lưới chấm) cho HR/quản lý/nhân sự | — | pending | 05,06 |
