...
| T15 | Phase 5 (after-sale, Guardian UI, dashboard BGĐ/MAES, certificate auto-gen) | planning+feature | plan.md Phase 5 + lát cắt verify | 🟡 đang chạy — **Guardian-link ✅ done-by-evidence** 2026-06-24 (lát cắt #1) |
| T15.1 | Guardian-link: khóa bất biến A3 (PH thấy đúng+đủ con) | bảo mật/coverage | int-test mutation-proven 11 surface + 2-agent review | ✅ done 2026-06-24 — feature đã build sẵn; gap là proof. `guardian-principal-isolation.int.test.ts` 26 case, int-suite **72/72**, A3 kín. 2-agent review (bắt "A3 kín" sớm → bổ sung 4 surface + dùng `loginParent` thật). Defer: SSE + student-self. Plan: `plans/260624-1746-guardian-link-verify/`. |
