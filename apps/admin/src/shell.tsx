      ...
      >
        <Group justify="space-between" wrap="nowrap" style={{ width: '100%' }}>
          <Group gap="md" wrap="nowrap" style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
            ...
            <Text fw={700} truncate style={{ color: 'var(--cmc-brand)', fontSize: 18, flexShrink: 0 }}>
              {surfaceCopy.topbarBrand}
            </Text>
            {/* Breadcrumb repeats "Teacher Lite"/topbarBrand's own words and is the first thing to
                overflow the fixed 56px header on mobile — drop it below sm, keep it on desktop where
                there's room. */}
            <Text size="sm" truncate visibleFrom="sm" style={{ color: 'var(--cmc-text-muted)' }}>
