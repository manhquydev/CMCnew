...
| TEACH-PAGINATE | Class list: PAGE_SIZE=20 pagination, Pagination component, search filter with page-reset (ported into admin class workspace) | normal | UI/Infra | `apps/admin/src/class-workspace.tsx` (classPage, setClassPage, Pagination) |
