...
Also run `.\scripts\bin\harness-cli.exe query matrix` before starting work.
...
This project is indexed by GitNexus as **CMCnew** (3544 symbols, 7294 relationships, 199 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/CMCnew/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/CMCnew/context` | Codebase overview, check index freshness |
| `gitnexus://repo/CMCnew/clusters` | All functional areas |
| `gitnexus://repo/CMCnew/processes` | All execution flows |
| `gitnexus://repo/CMCnew/process/{name}` | Step-by-step execution trace |
