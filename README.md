...
**Trạng thái hiện tại: đang chạy production thật** tại `erp.cmcvn.edu.vn` (ERP + panel giáo vụ) và `hoc.cmcvn.edu.vn` (LMS), deploy tự động qua Jenkins CI/CD trên VPS riêng.
...
🟢 **Email dual-transport** (2026-07-03) — Graph (nội bộ) + Brevo (ngoài hệ thống) đã merge `main`, ship inert (chưa bật Brevo — chờ operator).
